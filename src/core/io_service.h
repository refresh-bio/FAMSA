...
public:
  ...
  static size_t loadProfile(const std::string& file_name, std::vector<CSequence>& sequences, std::vector<CGappedSequence>& profile_sequences, int seq_no, memory_monotonic_safe* mma=nullptr);
